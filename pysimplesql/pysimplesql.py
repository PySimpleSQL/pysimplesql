...
def record(key:str, element:sg.Element=sg.I, size:Tuple[int,int]=None, label:str='', no_label:bool=False,
    ...
    :param key: The key must be named table.column in order to map to the database properly
                Additional unique identifier can be added after a ":", eg 'table.column:MyUniqueKey'.
                A WHERE clause can be passed after a '?' TODO: Provide example of how this can be passed.
                    Note, this must be passed after unique identifier, eg 'table.column?WHERECLAUSE', or 'table.column:MyUniqueKey?WHERECLAUSE'
...
def actions(key:str, default:bool=True, edit_protect:bool=None, navigation:bool=None, insert:bool=None,
    ...
    :param key: The table name that this "element" will provide actions for.
                Additional unique identifier can be added after a ":", eg 'table:MyUniqueKey'.
                Note that this is a root key, and the various elements will build from
...
def selector(key:str, element:sg.Element=sg.LBox, size:Tuple[int,int]=None, filter:str=None,
             **kwargs) -> sg.Element:
    """
    ...
    :param key: The table name in the database that this selector will act on.
            Additional unique identifier can be added after a ":", eg 'table:MyUniqueKey'.
