...
headings2=ss.TableHeadings(sort_enable=True)
headings2.add('title', 'Title', width=40)
headings2.add('entry_date', 'Date', width=10)
headings2.add('mood_id', 'Mood', width=20)
