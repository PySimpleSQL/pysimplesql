...
INSERT INTO "Colors" ("name","example","primary") VALUES ("Orange","Traffic cones are orange.",0);
INSERT INTO "Colors" ("name","example","primary") VALUES ("Green","Grass is green.",0);
INSERT INTO "Colors" ("name","example","primary") VALUES ("Red","Apples are red.",1);
INSERT INTO "Colors" ("name","example","primary") VALUES ("Purple","Plums are purple.",0);
INSERT INTO "Colors" ("name","example","primary") VALUES ("Brown","Dirt is brown.",0);
INSERT INTO "Colors" ("name","example","primary") VALUES ("Black","Black is the absense of all color.",0);
INSERT INTO "Colors" ("name","example","primary") VALUES ("Yellow","Bananas are yellow.",1);
INSERT INTO "Colors" ("name","example","primary") VALUES ("White","White is the presence of all color",0);
INSERT INTO "Colors" ("name","example","primary") VALUES ("Blue","The ocean is blue",1);
'''
...
record_columns=[
    ...
    ss.record("Colors",'primary',label='Primary Color?',control=sg.CBox)
]
...
ss.actions("Colors"),
ss.selector("Colors",control=sg.Slider)+ss.selector("Colors",control=sg.Combo)
]
